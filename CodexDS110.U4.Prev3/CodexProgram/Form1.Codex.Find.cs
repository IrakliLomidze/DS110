    ...
    partial class Form1
    {
        ...
        private void Codex_Search_Button_Click(object sender, EventArgs e)
        {
            ...
            if (Codex_Result.Tables[0].Rows.Count >= maxlist)
            {
                ...
                //return;
                if ((ILG.Windows.Forms.ILGMessageBox.Show("მოძებნილი დოკუმენტების რაოდენობა მეტია " + maxlist.ToString() + " - ზე  " + System.Environment.NewLine +
            ...
            //this.F_Codex_List.DocumentListBox1.Configure(StatusAttributeConfiguration.ListConfiguration, app.state.RunTimeLicense.IsHistoryAccessGranted());
            ...
            //F_Codex_List.Panel_Preview_Dock();
        ...
        private String Codex_GenerateFindSQL()
        {
            ...
            if (this.Codex_Search_Combo.SelectedIndex == 1) // if Full Text Sellected
            {
                ...
                if (UseFullTest == false)
                {
                    ...
                    DSString.GeoUnitoGeo8(Codex_Search_Edit.Text)
                    + "%') or   " +
                        " ( C_DocText LIKE N'%" +
                    Codex_Search_Edit.Text
                    + "%'))";
       ...
       //     System.Windows.Forms.Clipboard.SetText(FullSQL);
        ...
        private String Codex_GenerateNewsSQL()
        {
            ...
            DateTime dd1 = ICG_FromNewsDate;
            if (ICG_News_DateCheck.Checked == false) dd1 = DateTime.Now;
