...
namespace ILG.Codex.CodexR4
{
    ...
    internal class DSRunTimeLicense
    {
        ...
        private bool V_IsConfidentialDocumentShowInList = true;
        private bool V_IsConfidentialDocumentIDShowInList = true;
        ...
        private bool V_IsConfidentialSaveAllow = false;
        ...
        */
        ...
        public DSAccessType GetRights(string profileName)
        {
            ...
            if (File.Exists(fname) == false) return DSAccessType.NoAccess;
