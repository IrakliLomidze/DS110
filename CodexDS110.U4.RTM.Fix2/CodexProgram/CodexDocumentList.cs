...
namespace ILG.Codex.CodexR4
{
    public partial class CodexDocumentList : Form
    {
        ...
        public CodexDocumentList(Form1 mainFormRef)
        {
            ...
            Document_Preview.ContextMenu = new ContextMenu();
        ...
        private void DocumentListBox1_DocumentClick(object sender, CodexDSListBox.CodexDSListEventArgs e)
        {
        ...
        {
            MainFormRef.CodexToolBar.ShowPopup("ListMenu"); 
        }
        ...
        {
            //Preview_Copy
            MainFormRef.CodexToolBar.ShowPopup("Preview");
        }
        ...
        {
            if (app.state.RunTimeLicense.IsDocumentViewRestrictedMode() == true) { ILG.Windows.Forms.ILGMessageBox.Show("მოქმედების ჩატარებისთვის თქვენ არ გაქვთ შესაბამისი უფლება"); return; }
