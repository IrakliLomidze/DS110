...
namespace ILG.Codex.CodexR4
{
    partial class Form1
    {
        ...
        private void LoadTreeData()
        {
            ...
            {
                string FavoritesFile = $"DS110_{app.state.DS_Profile_Id}.Favorites.XML";
                ...
                if (File.Exists(FavoritesFileNameFull) == true)
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        string FavoritesFileBackp = $"DS110_{app.state.DS_Profile_Id}.Favorites.XML.{DateTime.Now.Ticks.ToString()}.Backup";
        ...
        private void SaveTreeData()
        {
            ...
            using (new WaitCursor())
            {
                string _filename = $"DS110_{app.state.DS_Profile_Id}.Favorites.XML";
...
//===================================================================================================================
        ...
        private void SaveHistoryData()
        {
            using (new WaitCursor())
            {
                ...
                string _filename = $"DS110_{app.state.DS_Profile_Id}.History.XML";
       ...
       private void LoadHistoryData()
        {
            this.Cursor = System.Windows.Forms.Cursors.WaitCursor;
            string HistoryFile = "";
            { HistoryFile = $"DS110_{ app.state.DS_Profile_Id}.History.XML"; }
            ...
            if (File.Exists(s1) == true)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    string HistoryFileBackp = $"DS110_{app.state.DS_Profile_Id}.History.XML.{DateTime.Now.Ticks.ToString()}.Backup";
